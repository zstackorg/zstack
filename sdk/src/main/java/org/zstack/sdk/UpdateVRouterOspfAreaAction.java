...
public class UpdateVRouterOspfAreaAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.UpdateVRouterOspfAreaResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.UpdateVRouterOspfAreaResult value = res.getResult(org.zstack.sdk.UpdateVRouterOspfAreaResult.class);
        ret.value = value == null ? new org.zstack.sdk.UpdateVRouterOspfAreaResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/routerArea/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateVRouterOspfArea";
        return info;
    }
